...
* Lecture 19, the final project tutorial, and lecture 20 are on [canvas](https://canvas.stanford.edu/courses/110850/external_tools/5384) because of FERPA restrictions. A SUNet ID is required to access this material. These classes were done using [zoom](https://uit.stanford.edu/service/zoom) because of the [coronavirus](https://www.trackcorona.live/).
